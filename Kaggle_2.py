...
# Make cross validated predictions for the titanic dataframe
...
# We'll concatenate someone's last name with FamilySize to get a unique family id.
...
#######################################################################################
# use univariate feature selection. This essentially goes column by column, 
# and figures out which columns correlate most closely with what we're trying to predict (Survived)
